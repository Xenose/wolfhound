...
u32 _wh_hash_xx32(_wh_hash_xx32_params params) {
	...
	static u32 p1 = 0x9E3779B1U;  // 0b 10011110001101110111100110110001
	static u32 p2 = 0x85EBCA77U;  // 0b 10000101111010111100101001110111
	static u32 p3 = 0xC2B2AE3DU;  // 0b 11000010101100101010111000111101
	static u32 p4 = 0x27D4EB2FU;  // 0b 00100111110101001110101100101111
	static u32 p5 = 0x165667B1U;  // 0b 00010110010101100110011110110001
