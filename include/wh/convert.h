...
extern char* _wh_int2str128(_wh_int2str128_params params);

extern i64 _wh_str2int(_wh_str2int_params params);
extern i128 _wh_str2int128(_wh_str2int128_params params);
...
#define wh_int2str128(...)      WH_EPF(_wh_int2str128((_wh_int2str128_params) { __VA_ARGS__ }))
#define wh_str2int(...)         WH_EPF(_wh_str2int((_wh_str2int_params) { __VA_ARGS__ }))
#define wh_str2int128(...)      WH_EPF(_wh_str2int128((_wh_str2int128_params) { __VA_ARGS__ }))
